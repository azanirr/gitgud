declare global {
  ...
  const createGame: typeof import('../../server/utils/db').createGame
  ...
  const deleteGame: typeof import('../../server/utils/db').deleteGame
  ...
  const readGames: typeof import('../../server/utils/db').readGames
  ...
  const updateGame: typeof import('../../server/utils/db').updateGame
  ...
  const writeGames: typeof import('../../server/utils/db').writeGames
}
// for type re-export
declare global {
  // @ts-ignore
  ...
  // @ts-ignore
  export type { Game } from '../../server/utils/db'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/mekari/Documents/gitgud_complete/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/mekari/Documents/gitgud_complete/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { readGames, writeGames, createGame, updateGame, deleteGame } from '/Users/mekari/Documents/gitgud_complete/server/utils/db';